...
namespace PostServiceWebApplication.Controllers
{
    public class ParcelsController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? id, string? name)
        {
            ...
            var p = _context.Parcels.Where(p => p.Status == null);
        ...
        public IActionResult Create(int id)
        {
            ...
            ViewData["TypeId"] = new SelectList(_context.ParcelTypes, "Id", "Length");
            return View();
        }
        ...
        public async Task<IActionResult> Edit(long? id)
        {
            ...
            ViewData["ClientFromId"] = new SelectList(_context.Clients.Where(c => c.Id == parcel.ClientFromId), "Id", "Name");
            ViewData["ClientToId"] = new SelectList(_context.Clients.Where(c => c.Id != parcel.ClientFromId), "Id", "Name");
            ViewData["StatusId"] = new SelectList(_context.Statuses, "Id", "Name");
            ViewData["TypeId"] = new SelectList(_context.ParcelTypes, "Id", "Length");
            return View(parcel);
        }
